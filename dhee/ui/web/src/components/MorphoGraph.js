...
export const MorphoGraph = () => {
    ...
    return (_jsxs("div", { style: { width: "100%", height: "100%", position: "relative", background: "#0a0a0f", overflow: "hidden" }, children: [_jsxs("div", { style: {
                ...
                }, children: [_jsx("span", { style: { color: "#ff6b35", fontWeight: 700, letterSpacing: "0.08em" }, children: "\u25C9 MORPHO CORTEX" }), stats && (_jsxs(_Fragment, { children: [_jsx("span", { style: { color: "#666" }, children: "|" }), _jsxs("span", { style: { color: TYPE_COLORS.memory }, children: ["\u25CF ", stats.memories, " mems"] }), _jsxs("span", { style: { color: TYPE_COLORS.scene }, children: ["\u25CF ", stats.scenes, " scenes"] }), _jsxs("span", { style: { color: TYPE_COLORS.episode }, children: ["\u25CF ", stats.episodes, " eps"] }), _jsxs("span", { style: { color: TYPE_COLORS.profile }, children: ["\u25CF ", stats.profiles, " profs"] }), _jsxs("span", { style: { color: TYPE_COLORS.entity }, children: ["\u25CF ", stats.entities, " ents"] }), _jsxs("span", { style: { color: TYPE_COLORS.category }, children: ["\u25CF ", stats.categories, " cats"] }), _jsxs("span", { style: { color: TYPE_COLORS.fact }, children: ["\u25CF ", stats.facts, " facts"] }), _jsx("span", { style: { color: "#666" }, children: "|" }), _jsxs("span", { style: { color: "#555" }, children: [stats.edge_count, " edges"] })] }))] }), loading && (_jsx("div", { style: {
                    position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center",
                    color: "#ff6b35", fontFamily: "monospace", fontSize: 14, zIndex: 20,
                }, children: _jsx("span", { style: { animation: "pulse 1.5s infinite" }, children: "\u25C9 Loading neural graph from Dhee memory..." }) })), error && (_jsxs("div", { style: {
                    position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center",
                    color: "#ef4444", fontFamily: "monospace", fontSize: 13, zIndex: 20,
                }, children: ["Error: ", error] })), _jsx("canvas", { ref: canvasRef, style: { width: "100%", height: "100%", display: "block", cursor: panRef.current.dragging ? "grabbing" : "grab" }, onMouseMove: onMouseMove, onMouseDown: onMouseDown, onMouseUp: onMouseUp, onMouseLeave: onMouseUp, onWheel: onWheel }), hovered && (_jsxs("div", { style: {
                    position: "absolute",
                ...
                }, children: [_jsxs("div", { style: { color: TYPE_COLORS[hovered.type], fontWeight: 700, fontSize: 10, letterSpacing: "0.06em", marginBottom: 4 }, children: [hovered.type.toUpperCase(), hovered.subtype ? ` · ${hovered.subtype}` : ""] }), _jsx("div", { style: { lineHeight: 1.4, wordBreak: "break-word" }, children: hovered.label }), _jsxs("div", { style: { marginTop: 4, color: "#666", fontSize: 10 }, children: ["strength: ", hovered.strength.toFixed(2), " \u00B7 importance: ", hovered.importance.toFixed(2)] })] })), _jsx("div", { style: {
                    position: "absolute", bottom: 12, right: 16,
                    display: "flex", gap: 14, fontFamily: "'Inter', system-ui", fontSize: 10, color: "#555", zIndex: 10,
                }, children: Object.entries(TYPE_COLORS).map(([t, c]) => (_jsxs("span", { style: { display: "flex", alignItems: "center", gap: 4 }, children: [_jsx("span", { style: { width: 6, height: 6, borderRadius: "50%", background: c, display: "inline-block" } }), t] }, t))) })] }));
};
